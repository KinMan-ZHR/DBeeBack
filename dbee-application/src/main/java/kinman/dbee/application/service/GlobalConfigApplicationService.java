...
import kinman.dbee.api.param.global.GlobalConfigDeletionParam;
import kinman.dbee.api.param.global.GlobalConfigPageParam;
import kinman.dbee.api.response.PageData;
import kinman.dbee.api.response.model.GlobalConfigAgg;
import kinman.dbee.api.response.model.GlobalConfigAgg.BaseGlobalConfig;
import kinman.dbee.api.response.model.GlobalConfigAgg.CodeRepo;
import kinman.dbee.api.response.model.GlobalConfigAgg.CustomizedMenu;
...
import kinman.dbee.infrastructure.model.Menu;
...
public class GlobalConfigApplicationService extends DeploymentApplicationService {
	...
	public String menu(LoginUser loginUser) {
		String menuPath = Constants.DBEE_HOME + "/static/api/";
