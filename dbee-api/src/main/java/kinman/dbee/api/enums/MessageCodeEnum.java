...
public enum MessageCodeEnum {
	...
	SYS_USER_IS_NONEXISTENCE("200000", "用户不存在"),
	INVALID_LOGIN_TOKEN("200000", "无效的登录token"),
	...
	FILE_BEAT_K8S_FILE_NONEXISTENCE("200000", "filebeat-k8s文件不存在"),
	
	//服务器集群配置
	AUTH_TYPE_IS_EMPTY("200000", "认证方式不能为空"),
	CLUSTER_NAME_EXISTENCE("200000", "集群名称已经存在"),
	IMAGE_REPO_AUTH_FAILURE("200000", "创建镜像仓库认证key失败，请检查集群管理配置"),
	DBEE_SERVER_URL_FAILURE("200000", "创建Dbee服务器地址失败，请重新进行该操作"),
	CLUSTER_ID_IS_EMPTY("200000", "集群编号不能为空"),
	CLUSTER_NAME_IS_EMPTY("200000", "集群名称不能为空"),
	CLUSTER_URL_IS_EMPTY("200000", "集群地址不能为空"),
	AUTH_TOKEN_IS_EMPTY("200000", "集群认证令牌不能为空"),
	CLUSTER_AUTH_PASSWORD_IS_EMPTY("200000", "集群认证名称和密码不能为空"),
	NAMESPACE_NAME_EMPTY("200000", "命名空间名称不能为空"),
	CLUSTER_EXISTENCE("200000", "集群不存在"),
	TAGE_EXISTENCE("200000", "标签名称已经存在"),
	CLUSTER_NAMESPACE_ID_IS_EMPTY("200000", "集群命名空间编号不能为空"),
	CLUSTER_NAMESPACE_IS_EMPTY("200000", "集群命名空间不能为空"),
	...
	NAMESPACE_NONEXISTENCE("200000", "命名空间不存在"),
	...
	APP_IS_NONEXISTENCE("200000", "应用不存在"),
	...
	APP_ENV_TAG_EXISTENCE("200000", "环境标识已经存在"),
	APP_ENV_NONEXISTENCE("200000", "环境不存在"),
	...
	APP_BRANCH_NAME_NONEXISTENCE("200000", "分支名称已经存在"),
	...
	REPLICA_NAME_INVALID("200000", "无效的副本名称"),
	...
	DEPLOYMENT_VERSION_ID_IS_EMPTY("200000", "版本编号不能为空"),
	ADD_PUBLISHED_DETAIL("200000", "新增部署记录失败"),
	UPDATE_PUBLISHED_DETAIL("200000", "修改部署记录失败"),
	APPROVE("800000", "提交成功，等待审核"),
	REQUIRED_APPROVER("200000", "审批人不能为空"),
	DEPLOYING_BRANCH_IS_APPROVED("200000", "不是待审核状态"),
	DEPLOYING_BRANCH_NONEXISTENCE("200000", "部署记录不存在"),
